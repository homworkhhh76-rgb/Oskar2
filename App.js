...
import { AppProvider, useApp } from './context__AppContext.js?v=7.9.4.36-customer-portal-stable-2';
import { Header } from './components__common__Header.js?v=7.9.4.36-customer-portal-stable-2';
import { Sidebar } from './components__common__Sidebar.js?v=7.9.4.36-customer-portal-stable-2';
import { BottomNav } from './components__common__BottomNav.js?v=7.9.4.36-customer-portal-stable-2';
import { Toast } from './components__common__Toast.js?v=7.9.4.36-customer-portal-stable-2';
import { SyncModal } from './components__sync__SyncModal.js?v=7.9.4.36-customer-portal-stable-2';
import { POSView } from './components__pos__POSView.js?v=7.9.4.36-customer-portal-stable-2';
import { DashboardView } from './components__dashboard__DashboardView.js?v=7.9.4.36-customer-portal-stable-2';
import { SalesView } from './components__sales__SalesView.js?v=7.9.4.36-customer-portal-stable-2';
import { PurchasesView } from './components__purchases__PurchasesView.js?v=7.9.4.36-customer-portal-stable-2';
import { ProductsView } from './components__products__ProductsView.js?v=7.9.4.36-customer-portal-stable-2';
import { CategoriesView } from './components__categories__CategoriesView.js?v=7.9.4.36-customer-portal-stable-2';
import { InventoryView } from './components__inventory__InventoryView.js?v=7.9.4.36-customer-portal-stable-2';
import { CustomersView } from './components__customers__CustomersView.js?v=7.9.4.36-customer-portal-stable-2';
import { SuppliersView } from './components__suppliers__SuppliersView.js?v=7.9.4.36-customer-portal-stable-2';
import { AccountsView } from './components__accounts__AccountsView.js?v=7.9.4.36-customer-portal-stable-2';
import { ExpensesView } from './components__expenses__ExpensesView.js?v=7.9.4.36-customer-portal-stable-2';
import { VouchersView } from './components__vouchers__VouchersView.js?v=7.9.4.36-customer-portal-stable-2';
import { EmployeesView } from './components__employees__EmployeesView.js?v=7.9.4.36-customer-portal-stable-2';
import { BarcodesView } from './components__barcodes__BarcodesView.js?v=7.9.4.36-customer-portal-stable-2';
import { ReportsView } from './components__reports__ReportsView.js?v=7.9.4.36-customer-portal-stable-2';
import { TrashView } from './components__trash__TrashView.js?v=7.9.4.36-customer-portal-stable-2';
import { SettingsView } from './components__settings__SettingsView.js?v=7.9.4.36-customer-portal-stable-2';
import { ThermalReceiptModal } from './components__pos__ThermalReceiptModal.js?v=7.9.4.36-customer-portal-stable-2';
import { DEFAULT_LOGO_DATA_URL } from './brand__logo.js?v=7.9.4.36-customer-portal-stable-2';
import { LoginGate } from './components__auth__LoginGate.js?v=7.9.4.36-customer-portal-stable-2';
import { RestaurantProvider } from './restaurant__context__RestaurantContext.js?v=7.9.4.36-customer-portal-stable-2';
import { RestaurantTablesView } from './restaurant__components__RestaurantTablesView.js?v=7.9.4.36-customer-portal-stable-2';
import { RestaurantWaiterView } from './restaurant__components__RestaurantWaiterView.js?v=7.9.4.36-customer-portal-stable-2';
import { RestaurantKDSView } from './restaurant__components__RestaurantKDSView.js?v=7.9.4.36-customer-portal-stable-2';
import { RestaurantWasteView } from './restaurant__components__RestaurantWasteView.js?v=7.9.4.36-customer-portal-stable-2';
import { RestaurantSettingsPanel } from './restaurant__components__RestaurantSettingsPanel.js?v=7.9.4.36-customer-portal-stable-2';
import { OscarAI } from './components__ai__OscarAI.js?v=7.9.4.36-customer-portal-stable-2';
import { canAccessTab, firstAllowedTab } from './utils__permissions.js?v=7.9.4.36-customer-portal-stable-2';
