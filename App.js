...
import { AppProvider, useApp } from './context__AppContext.js?v=7.9.4.36-github-shift-fix-1';
import { Header } from './components__common__Header.js?v=7.9.4.36-github-shift-fix-1';
import { Sidebar } from './components__common__Sidebar.js?v=7.9.4.36-github-shift-fix-1';
import { BottomNav } from './components__common__BottomNav.js?v=7.9.4.36-github-shift-fix-1';
import { Toast } from './components__common__Toast.js?v=7.9.4.36-github-shift-fix-1';
import { SyncModal } from './components__sync__SyncModal.js?v=7.9.4.36-github-shift-fix-1';
import { POSView } from './components__pos__POSView.js?v=7.9.4.36-github-shift-fix-1';
import { DashboardView } from './components__dashboard__DashboardView.js?v=7.9.4.36-github-shift-fix-1';
import { SalesView } from './components__sales__SalesView.js?v=7.9.4.36-github-shift-fix-1';
import { PurchasesView } from './components__purchases__PurchasesView.js?v=7.9.4.36-github-shift-fix-1';
import { ProductsView } from './components__products__ProductsView.js?v=7.9.4.36-github-shift-fix-1';
import { CategoriesView } from './components__categories__CategoriesView.js?v=7.9.4.36-github-shift-fix-1';
import { InventoryView } from './components__inventory__InventoryView.js?v=7.9.4.36-github-shift-fix-1';
import { CustomersView } from './components__customers__CustomersView.js?v=7.9.4.36-github-shift-fix-1';
import { SuppliersView } from './components__suppliers__SuppliersView.js?v=7.9.4.36-github-shift-fix-1';
import { AccountsView } from './components__accounts__AccountsView.js?v=7.9.4.36-github-shift-fix-1';
import { ExpensesView } from './components__expenses__ExpensesView.js?v=7.9.4.36-github-shift-fix-1';
import { VouchersView } from './components__vouchers__VouchersView.js?v=7.9.4.36-github-shift-fix-1';
import { EmployeesView } from './components__employees__EmployeesView.js?v=7.9.4.36-github-shift-fix-1';
import { BarcodesView } from './components__barcodes__BarcodesView.js?v=7.9.4.36-github-shift-fix-1';
import { ReportsView } from './components__reports__ReportsView.js?v=7.9.4.36-github-shift-fix-1';
import { TrashView } from './components__trash__TrashView.js?v=7.9.4.36-github-shift-fix-1';
import { SettingsView } from './components__settings__SettingsView.js?v=7.9.4.36-github-shift-fix-1';
import { ThermalReceiptModal } from './components__pos__ThermalReceiptModal.js?v=7.9.4.36-github-shift-fix-1';
import { DEFAULT_LOGO_DATA_URL } from './brand__logo.js?v=7.9.4.36-github-shift-fix-1';
import { LoginGate } from './components__auth__LoginGate.js?v=7.9.4.36-github-shift-fix-1';
import { RestaurantProvider } from './restaurant__context__RestaurantContext.js?v=7.9.4.36-github-shift-fix-1';
import { RestaurantTablesView } from './restaurant__components__RestaurantTablesView.js?v=7.9.4.36-github-shift-fix-1';
import { RestaurantWaiterView } from './restaurant__components__RestaurantWaiterView.js?v=7.9.4.36-github-shift-fix-1';
import { RestaurantKDSView } from './restaurant__components__RestaurantKDSView.js?v=7.9.4.36-github-shift-fix-1';
import { RestaurantWasteView } from './restaurant__components__RestaurantWasteView.js?v=7.9.4.36-github-shift-fix-1';
import { RestaurantSettingsPanel } from './restaurant__components__RestaurantSettingsPanel.js?v=7.9.4.36-github-shift-fix-1';
import { OscarAI } from './components__ai__OscarAI.js?v=7.9.4.36-github-shift-fix-1';
import { canAccessTab, firstAllowedTab } from './utils__permissions.js?v=7.9.4.36-github-shift-fix-1';
