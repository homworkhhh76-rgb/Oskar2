...
import { AppProvider, useApp } from './context__AppContext.js?v=7.9.4.46-profit-report';
import { Header } from './components__common__Header.js?v=7.9.4.46-profit-report';
import { Sidebar } from './components__common__Sidebar.js?v=7.9.4.46-profit-report';
import { BottomNav } from './components__common__BottomNav.js?v=7.9.4.46-profit-report';
import { Toast } from './components__common__Toast.js?v=7.9.4.46-profit-report';
import { SyncModal } from './components__sync__SyncModal.js?v=7.9.4.46-profit-report';
import { POSView } from './components__pos__POSView.js?v=7.9.4.46-profit-report';
import { DashboardView } from './components__dashboard__DashboardView.js?v=7.9.4.46-profit-report';
import { SalesView } from './components__sales__SalesView.js?v=7.9.4.46-profit-report';
import { PurchasesView } from './components__purchases__PurchasesView.js?v=7.9.4.46-profit-report';
import { ProductsView } from './components__products__ProductsView.js?v=7.9.4.46-profit-report';
import { CategoriesView } from './components__categories__CategoriesView.js?v=7.9.4.46-profit-report';
import { InventoryView } from './components__inventory__InventoryView.js?v=7.9.4.46-profit-report';
import { CustomersView } from './components__customers__CustomersView.js?v=7.9.4.46-profit-report';
import { SuppliersView } from './components__suppliers__SuppliersView.js?v=7.9.4.46-profit-report';
import { AccountsView } from './components__accounts__AccountsView.js?v=7.9.4.46-profit-report';
import { ExpensesView } from './components__expenses__ExpensesView.js?v=7.9.4.46-profit-report';
import { VouchersView } from './components__vouchers__VouchersView.js?v=7.9.4.46-profit-report';
import { EmployeesView } from './components__employees__EmployeesView.js?v=7.9.4.46-profit-report';
import { BarcodesView } from './components__barcodes__BarcodesView.js?v=7.9.4.46-profit-report';
import { ReportsView } from './components__reports__ReportsView.js?v=7.9.4.46-profit-report';
import { TrashView } from './components__trash__TrashView.js?v=7.9.4.46-profit-report';
import { SettingsView } from './components__settings__SettingsView.js?v=7.9.4.46-profit-report';
import { ThermalReceiptModal } from './components__pos__ThermalReceiptModal.js?v=7.9.4.46-profit-report';
import { DEFAULT_LOGO_DATA_URL } from './brand__logo.js?v=7.9.4.46-profit-report';
import { LoginGate } from './components__auth__LoginGate.js?v=7.9.4.46-profit-report';
import { RestaurantProvider } from './restaurant__context__RestaurantContext.js?v=7.9.4.46-profit-report';
import { RestaurantTablesView } from './restaurant__components__RestaurantTablesView.js?v=7.9.4.46-profit-report';
import { RestaurantWaiterView } from './restaurant__components__RestaurantWaiterView.js?v=7.9.4.46-profit-report';
import { RestaurantKDSView } from './restaurant__components__RestaurantKDSView.js?v=7.9.4.46-profit-report';
import { RestaurantWasteView } from './restaurant__components__RestaurantWasteView.js?v=7.9.4.46-profit-report';
import { RestaurantSettingsPanel } from './restaurant__components__RestaurantSettingsPanel.js?v=7.9.4.46-profit-report';
import { OscarAI } from './components__ai__OscarAI.js?v=7.9.4.46-profit-report';
import { canAccessTab, firstAllowedTab } from './utils__permissions.js?v=7.9.4.46-profit-report';
import { startTelegramAutomation } from './services__telegram.js?v=7.9.4.46-profit-report';
