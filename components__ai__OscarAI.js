...
import { askOscar, getAIConfig, aiHealthCheck, fileToDataUrl } from './services__ai.js?v=7.9.4.46-profit-report';
import { executeAIActions, isMutationAction } from './services__aiActions.js?v=7.9.4.46-profit-report';
import { canAccessPermission } from './utils__permissions.js?v=7.9.4.46-profit-report';
