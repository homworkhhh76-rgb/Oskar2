import { getBrandLogoDataUrl, DEFAULT_LOGO_DATA_URL } from './brand__logo.js?v=7.9.4.36-customer-portal-stable-2';
import { code128Geometry } from './utils__code128.js?v=7.9.4.36-customer-portal-stable-2';
