...
import { BarcodeCameraModal } from './components__pos__CameraScannerModal.js';
import { calculateUnitConversions, formatStockBreakdown } from './utils__unitTree.js';
...
export const ProductsView = () => {
    ...
    return (_jsxs("div", { id: "products-screen", className: "p-4 sm:p-6 space-y-4 max-w-7xl mx-auto text-right select-none", children: [_jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-xl font-black text-slate-900 dark:text-white", children: "\u0625\u062f\u0627\u0631\u0629 \u0627\u0644\u0623\u0635\u0646\u0627\u0641 \u0648\u0634\u062c\u0631\u0629 \u0627\u0644\u0648\u062d\u062f\u0627\u062a" }), _jsx("p", { className: "text-xs text-slate-500 mt-0.5", children: "\u062a\u0639\u062f\u062f \u0648\u062d\u062f\u0627\u062a \u062d\u0642\u064a\u0642\u064a (\u0645\u0634\u0637\u0627\u062d\u060c \u0643\u0631\u062a\u0648\u0646\u0629\u060c \u0628\u0627\u0643\u064a\u062a\u060c \u062d\u0628\u0629)\u060c \u0628\u0627\u0631\u0643\u0648\u062f \u0645\u062a\u0639\u062f\u062f \u0644\u0643\u0644 \u0648\u062d\u062f\u0629\u060c \u0648\u062a\u062a\u0628\u0639 \u0627\u0644\u0645\u062e\u0632\u0648\u0646" })] }), _jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [_jsxs("button", { onClick: async () => {
                                    if (!tableContainerRef.current)
                                        return;
                                    await downloadElementAsPDF('products-table-container', `دليل_الأصناف_${new Date().toISOString().slice(0, 10)}.pdf`);
                                    showToast('تم تصدير دليل الأصناف كـ PDF بنجاح', 'success');
                                }, className: "flex items-center gap-1.5 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 text-xs font-bold hover:bg-slate-50 transition shadow-xs", title: "\u062a\u0646\u0632\u064a\u0644 \u0643\u0640 PDF", children: [_jsx(Download, { className: "w-4 h-4 text-rose-600" }), _jsx("span", { children: "PDF" })] }), _jsxs("button", { onClick: async () => {
                                    if (!tableContainerRef.current)
                                        return;
                                    await downloadElementAsImage('products-table-container', `دليل_الأصناف_${new Date().toISOString().slice(0, 10)}.png`);
                                    showToast('تم تصدير دليل الأصناف كصورة بنجاح', 'success');
