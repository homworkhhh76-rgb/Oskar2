...
import { BarcodeCameraModal } from './components__pos__CameraScannerModal.js?v=7.9.4.36-stock-stable-1';
import { calculateUnitConversions, formatStockBreakdown } from './utils__unitTree.js?v=7.9.4.36-stock-stable-1';
